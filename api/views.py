...
def admin_analytics(request):
    ...
    try:
        ...
        post_stats = {
            ...
            ).order_by('-like_count').select_related('design', 'user').values(
            ...
            ).order_by('-comment_count').select_related('design').values(
            ...
            ).order_by('-favorite_count').select_related('design').values(
